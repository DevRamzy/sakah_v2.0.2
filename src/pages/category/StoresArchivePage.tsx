...
const StoresArchivePage: React.FC = () => {
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <span className="text-neutral-600">
                {loading ? 'Searching...' : `${totalListings} store${totalListings === 1 ? '' : 's'} found`}
              </span>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex border border-neutral-300 rounded-lg overflow-hidden">
                  <button
                    ...
                    className={`p-2 ${viewMode === 'grid' ? 'bg-purple-600 text-white' : 'bg-white text-neutral-600 hover:bg-neutral-50'}`}
                  >
                    <Grid className="w-4 h-4" />
                  </button>
                  <button
                    onClick={() => setViewMode('list')}
                    className={`p-2 ${viewMode === 'list' ? 'bg-purple-600 text-white' : 'bg-white text-neutral-600 hover:bg-neutral-50'}`}
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleFilterChange('openNow', e.target.value)}
                    className="w-full px-3 py-2 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-neutral-300 rounded-lg focus:outline-none focus: focus:ring-2 focus:ring-purple-400"
                  >
                    <option value="">Any Services</option>
                    <option value="delivery">Offers Delivery</option>
                    <option value="pickup">Offers Pickup</option>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-neutral-800 mb-2">Error Loading Stores</h3>
            <p className="text-neutral-600 mb-4">{error}</p>
            <Button onClick={() => fetchListings(1, true)} className="bg-purple-600 hover:bg-purple-700 text-white">
              Try Again
            </Button>
          </div>
        ) : listings.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-neutral-800 mb-2">No Stores Found</h3>
