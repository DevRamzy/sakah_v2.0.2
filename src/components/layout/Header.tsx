      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-black border-t border-neutral-700">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="border-t border-neutral-700 my-2"></div> {/* Separator */}
            <div className="pt-2">
                <Button variant="primary" size="sm" className="w-full bg-yellow-400 text-black hover:bg-yellow-500 rounded-full">
                    SakahSoko
                </Button>
            </div>
            {isAuthenticated && user ? (
