/*
  ...
  2. Changes
    ...
    - Add admin functions:
      ...
      - approve_listing(): Approve a listing
      - reject_listing(): Reject a listing
  ...
  3. Security
    ...
    - Public can only view approved listings
    - Users can view their own listings regardless of status
    - Users can only update/delete listings that aren't approved
*/
